...
public class VelocityPseudoCorrelationGraph extends AbstractCrossSectionColourCodedGraph {
	 ...
	 */
	public VelocityPseudoCorrelationGraph(AbstractDataSetUniqueId dataSetId, MAJFCStackedPanelWithFrame parent, Vector<Integer> yCoords, Vector<Integer> zCoords, Vector<Double> correlations, String graphTitle) throws HeadlessException {
		super(dataSetId, parent, new Object[] {yCoords, zCoords, correlations}, 50, null, graphTitle, DAStrings.getString(DAStrings.VELOCITY_PSEUDO_CORRELATION_GRAPH_LEGEND_TEXT), false);
	}
	...
	protected void showTheVerticalSectionGraph() {
		if (mVerticalSectionGraph == null) {
			String gridTitle = DAStrings.getString(DAStrings.VELOCITY_PSEUDO_CORRELATION_GRAPH_TITLE);
			String xAxisTitle = DAStrings.getString(DAStrings.VERTICAL_DISTRIBUTION_OF_VELOCITY_PSEUDO_CORRELATION_GRAPH_X_AXIS_TITLE);
			String yAxisTitle = DAStrings.getString(DAStrings.VERTICAL_DISTRIBUTION_OF_VELOCITY_PSEUDO_CORRELATION_GRAPH_Y_AXIS_TITLE);
			String legendText = DAStrings.getString(DAStrings.VERTICAL_DISTRIBUTION_OF_VELOCITY_PSEUDO_CORRELATION_GRAPH_LEGEND_KEY_LABEL);
	...
	protected void showTheHorizontalSectionGraph() {
		if (mHorizontalSectionGraph == null) {
			String gridTitle = DAStrings.getString(DAStrings.VELOCITY_PSEUDO_CORRELATION_GRAPH_TITLE);
			String xAxisTitle = DAStrings.getString(DAStrings.HORIZONTAL_DISTRIBUTION_OF_VELOCITY_PSEUDO_CORRELATION_GRAPH_X_AXIS_TITLE);
			String yAxisTitle = DAStrings.getString(DAStrings.HORIZONTAL_DISTRIBUTION_OF_VELOCITY_PSEUDO_CORRELATION_GRAPH_Y_AXIS_TITLE);
			String legendText = DAStrings.getString(DAStrings.HORIZONTAL_DISTRIBUTION_OF_VELOCITY_PSEUDO_CORRELATION_GRAPH_LEGEND_KEY_LABEL);
	...
	protected Vector<String> getDepthAveragedGraphLabels() {
		String gridTitle = DAStrings.getString(DAStrings.DEPTH_AVERAGED_VELOCITY_PSEUDO_CORRELATION_GRAPH_TITLE);
		String xAxisTitle = DAStrings.getString(DAStrings.DEPTH_AVERAGED_VELOCITY_PSEUDO_CORRELATION_GRAPH_X_AXIS_TITLE);
		String yAxisTitle = DAStrings.getString(DAStrings.DEPTH_AVERAGED_VELOCITY_PSEUDO_CORRELATION_GRAPH_Y_AXIS_TITLE);
